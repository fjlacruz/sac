...
!function(a, b) {
    ...
    function fb(a) {
        var b, c, d, e, f, g, h, i, j = {" GMT": " +0000", " EDT": " -0400", " EST": " -0500", " CDT": " -0500", " CST": " -0600", " MDT": " -0600", " MST": " -0700", " PDT": " -0700", " PST": " -0800"}, k = "YXWVUTSRQPONZABCDEFGHIKLM";
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, pe = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split("_"), qe = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), re = be, se = be;
    U("Y", 0, 0, function() {
        var a = this.year();
        return a <= 9999 ? "" + a : "+" + a
    }), U(0, ["YY", 2], 0, function() {
    ...
    var ve = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"), we = "Dom_Lun_Mar_Mier_Jue_Vie_Sab".split("_"), xe = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), ye = be, ze = be, Ae = be;
