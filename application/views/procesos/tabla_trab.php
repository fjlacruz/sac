...
<div class='filterable'>
   ...
   <table id="nueva" class="display" cellspacing="0" width="100%" >
      <thead align='center' >
         <tr class="filters" >
            <th style="display:none">id_trabajador</th>
            <th onkeypress="return soloNumeros(event)" align='center'>Empeado</th>
            <th onkeypress="return soloLetras(event)" align='center'>Rut</th>
            <th onkeypress="return soloLetras(event)" align='center'>Fecha</th>
            <th onkeypress="return soloLetras(event)" align='center'>Tipo Contrato</th>
            <th onkeypress="return soloLetras(event)" align='center'>Tipo Sueldo</th>
            <th onkeypress="return soloLetras(event)" align='center'>Acciones</th>
         </tr>
      </thead>
      <?php
         if ($resultados != "") {
            ...
            foreach ($resultados as $resultado) {
             $contenido.="<tr>      
             <td style='display:none'>" . "$resultado->id_trabajador" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->nombres_trabajador" . " "  . "$resultado->apellidos_trabajador" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->rut" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->fecha_contrato" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->tipo_contrato" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->tipo_sueldo" . "</td>
             <td align='center'> <span tooltip='Editar' flow='left'><button type='button' data-id='$resultado->id_trabajador' class='btn bg-olive btn-circle editButton' onclick='myFunction(3)'>
             <span class='fa  fa-pencil-square-o'></span>
             </button></span>
               <a href='" . base_url() . "Ingresos/verAdjunto/" . "$resultado->id_trabajador" . "'>
                 <span tooltip='Ver Adjunto' flow='left'><button type='button' class='btn bg-olive btn-circle'><span class='glyphicon glyphicon-search'></span></button></span></a>
                <span tooltip='Eliminar' flow='left'><button type='button' data-id='$resultado->id_trabajador' class='btn bg-olive btn-circle deleteButton'>
             <span class='fa  fa-close'></span>
             </button></span> 
                 </td>
...
<script type="text/javascript">
   ...
   $('.editButton').on('click', function() {
       ...
       $.ajax({
           url: "<?php echo base_url() . 'index.php/Remuneraciones/consultar_trabajador_id/'; ?>" + id,
           method: 'GET'
           ...
           $('#userForm')
           $('[name="id"]').val(obj.id_trabajador);
           $('[name="rut"]').val(obj.rut);
