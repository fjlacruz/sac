...
<script src="<?php echo base_url(); ?>application/scripts/ruta_ingresosExt.js"></script>
   ...
   <section class="content" >
      <div class="box box-success" id="section">
         <div class="box-header with-border">
            ...
            <p class="box-title">Administraci&oacute;n de Ingresos Extraordinarios</p>
   ...
   <section class="content"  style="width: 95%; align-content: center">
      <div class="box box-success" id="section">
         ...
         <div class="box-body">
            <div class="row">
               <div class="col-md-12">
                  <form id="formulario" method="POST" name="formulario" enctype="multipart/form-data" action="registrar_ingreso_Ext" onkeyup="activar(this);">
                     <?php
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="form-group col-sm-6">
                              <label>Cargo</label> 
                              <select name="id_cargo" id="id_cargo" readonly class="form-control redondeado custom-select" >
                                 <option value="">Selecione...</option>
                                 <?php
                                    foreach ($cargos as $i => $cargo) {
                                    echo '<option value="' . $cargo->id_cargo . '">' . $cargo->descripcion . '-$' .$cargo->monto. '</option>';
                                      }
                                      ?>                      
                              </select>
                           </div>
   ...
   <section class="content"  style="width: 95%; align-content: center">
      <div class="box box-success" id="section">
         <div class="box-header with-border">
            ...
            <p class="box-title">Editar Ingreso  Extraordinario</p>
            <div class="col-sm-12">
            ...
            <div class="row">
               <div class="col-md-12">
                  <form id="userForm" method="post" class="form-horizontal">
                     ...
                     <div class="col-sm-6">
                        <label>Cargo</label> 
                        <select name="id_cargo_modal" id="id_cargo_modal" readonly class="form-control redondeado custom-select" >
                        <?php
                           foreach ($cargos as $i => $cargo) {
                           echo '<option value="' . $cargo->id_cargo . '">' . $cargo->descripcion . '-$' .$cargo->monto. '</option>';
                             }
...
<script>
   //=================== Script para mostrar municipios y parroquias ==================//
       ...
       {
           $("#monto").load("<?php echo base_url() . 'index.php/Ingresos_extraordinarios/obtener_monto?id_cargo='; ?>" + $(this).val());
       });
        $(document).on("change", '#id_cargo_modal', function ()
       {
           $("#monto_modal").load("<?php echo base_url() . 'index.php/Ingresos_extraordinarios/obtener_monto?id_cargo_modal='; ?>" + $(this).val());
       });
