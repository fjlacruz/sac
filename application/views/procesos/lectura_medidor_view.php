   ...
   <body onload="nobackbutton();">
      ...
      <div class="box-header with-border">
          <span tooltip="Regresar">
            <a href="<?php echo base_url() ?>medidores/medidores" class="btn bg-orange btn-circle" type="button">
            <span class='glyphicon glyphicon-arrow-left'></a>
            </span>
         <h3 class="box-title">Lectura de Medidores</h3>
            ...
            <table id="nueva" class="display " cellspacing="0" width="100%" >
               <thead>
                  <tr class="filters">
                     ...
                     <th onkeypress="return soloNumeros(event)">Periodo</th>
               ...
               <?php
                  ...
                  $contenido.="<tr>      
                     ...
                     <span tooltip='Editar' flow='left'><button data-id='$resultado->id_lectura' class='btn bg-olive btn-circle editButton1' onclick='myFunction(1)'>
