            ...
            <div class="row">
               ...
               <form id="formulario" action="<?php echo base_url() ?>index.php/egresos/actualizar_adjunto" method="POST" name="formulario" enctype="multipart/form-data">
                  <div class="col-md-8" id="element" style="display: none;">
                     ...
                     <div class="col-md-5">
                        <span tooltip="Actualizar">
                        <button type="submit" class="btn bg-olive btn-circle"><span class='glyphicon glyphicon-pencil'></span></button>
                        </span>
                     </div>
                     <div class="col-md-1">&nbsp;</div>
...
<script>
   function fileValidation(){
       ...
       if(!allowedExtensions.exec(filePath)){
           ...
           setTimeout(function() {
           $("#formato_incorrecto").html("<div class='alert alert-warning alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button><i class='icon fa fa-warning'></i> Alerta...! Formato de Imagen Incorrecto (Seleccione un archivo jpg,jpeg,png,gif)....!!!.</div>").fadeOut(9000);
            },1000);
           fileInput.value = '';
           return false;
       }else{
