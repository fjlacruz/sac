...
<div class='filterable'>
   ...
   <table id="nueva" class="display" cellspacing="0" width="100%" >
      <thead align='center' >
         <tr class="filters" >
            <th style="display:none">id_ingreso_extraordinario</th>
            ...
            <th onkeypress="return soloLetras(event)" align='center'>Cargo</th>
      ...
      <?php
         if ($resultados != "") {
            ...
            foreach ($resultados as $resultado) {
             $contenido.="<tr>      
             <td style='display:none'>" . "$resultado->id_ingreso_extraordinario" . "</td>
             ...
             <td align='center' class='text-uppercase'>" .  "$resultado->descripcion_cargo" . "</td>
             <td align='center' class='text-uppercase'>" .  "$resultado->fecha_ingreso" . "</td>
             <td align='center'> <span tooltip='Editar' flow='left'><button type='button' data-id='$resultado->id_ingreso_extraordinario' class='btn bg-olive btn-circle editButton' onclick='myFunction(3)'>
             <span class='fa  fa-pencil-square-o'></span>
             </button></span>
             <span tooltip='Eliminar' flow='left'><button type='button' data-id='$resultado->id_ingreso_extraordinario' class='btn bg-olive btn-circle deleteButton'>
...
<script type="text/javascript">
   $(document).ready(function() {
       $('#userForm').formValidation({
           ...
           var $form = $(e.target);
           $.ajax({
               url: "<?php echo base_url() . 'index.php/ingresos_extraordinarios/actualizar_ingreso'; ?>",
               method: 'POST',
               data: $form.serialize()
   ...
   $('.editButton').on('click', function() {
       ...
       $.ajax({
           url: "<?php echo base_url() . 'index.php/Ingresos_extraordinarios/consultar_ingressos_id/'; ?>" + id,
           method: 'GET'
           ...
           $('#userForm')
           $('[name="id"]').val(obj.id_ingreso_extraordinario);
           ...
           $('[name="id_cargo_modal"]').val(obj.id_cargo);
           $('[name="descripcion_cargo_modal"]').val(obj.descripcion_cargo);
...
<script type="text/javascript">
   ...
   $('.deleteButton').on('click', function() {
       var id = $(this).attr('data-id');
       $.ajax({
           url: "<?php echo base_url() . 'index.php/Ingresos_extraordinarios/eliminar_ingreso/'; ?>" + id,
           method: 'POST'
